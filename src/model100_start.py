# typical runtime: 3m;  output shape: 1105 x 57672

def model100_start(per_person_info, person_concept_features, person_labs):
    ...
    df_cat = temporal_engineered_concept_features(person_concept_features, sel_cat_ids)    
