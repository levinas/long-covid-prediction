...
def npasc_waterfall_measurements(vis_full_model_xgb: Any, vis_full_features, vis_full_feature_mapping):
    # shape: (1, 79)
    ...
    feature_mapping_list = [i for i in mapping_list if i[0] in ['Measurements']]
    ...
    # special processing for measurements names
    selected_shap_values_display_names = [i.split('[')[0] for i in selected_shap_values_display_names]
