def model_z_start_test(per_person_info_test, person_concept_features_test, person_labs_test):
    ...
    df_cat = temporal_engineered_concept_features(person_concept_features_test, sel_cat_ids, agg_concepts=False)    
    ...
    df = per_person_info_test.drop(*bias_cols, *censor_cols) \
