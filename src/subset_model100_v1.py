...
def subset_model100_v1(model100_start, feature_expansion_model100_v1):
    df_feature = feature_expansion_model100_v1
    ...
    df = model100_start.select('person_id', 'pasc', 'time_to_pasc', *subset)
