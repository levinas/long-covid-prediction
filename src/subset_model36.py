...
def subset_model36(model36_start, feature_expansion_model36):
    df_feature = feature_expansion_model36
    ...
    df = model36_start.select('person_id', 'pasc', 'time_to_pasc', *subset)
