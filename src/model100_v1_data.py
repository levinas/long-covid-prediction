...
def model100_v1_data(subset_model100_v1, feature_subset_model100_v1):
    df_feature = feature_subset_model100_v1
    ...
    df = subset_model100_v1.select('person_id', 'pasc', 'time_to_pasc', *subset)
